      ...
      <div className="w-full max-w-sm space-y-8">
        ...
        <div className="space-y-4">
          ...
          >
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-3 rounded-lg border border-border bg-background px-4 py-3 text-sm font-medium shadow-sm hover:bg-accent transition-colors min-h-[44px]"
            >
